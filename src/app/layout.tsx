...
export const metadata: Metadata = {
  title: "Rainer's Labs - Premium Specialty Coffee",  description: "Experience exceptional artisan coffee at Rainer's Labs. Specialty espresso drinks crafted by expert baristas using premium beans.",  keywords: "specialty coffee, artisan espresso, local café, coffee shop, premium coffee",  metadataBase: new URL("https://rainierlabs.com"),
  alternates: {
    canonical: "https://rainierlabs.com"
  },
  openGraph: {
    title: "Rainer's Labs - Premium Specialty Coffee",    description: "Experience exceptional artisan coffee at Rainer's Labs. Specialty espresso drinks crafted by expert baristas.",    url: "https://rainierlabs.com",    siteName: "Rainer's Labs",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/close-up-barista-hands-preparing-coffee-customer-coffee-shop_93675-134687.jpg",        alt: "Rainer's Labs specialty coffee"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Rainer's Labs - Premium Specialty Coffee",    description: "Experience exceptional artisan coffee at Rainer's Labs.",    images: ["http://img.b2bpic.net/free-photo/close-up-barista-hands-preparing-coffee-customer-coffee-shop_93675-134687.jpg"]
  }
};
